            ...
            <div className='bg-gray-50 min-h-screen'>
                <div className="max-w-2xl mx-auto p-4">
                    <Card hover={false}>
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <div className='flex'>
                                <span className="bg-primary-100 text-primary-600 p-1 rounded-full mr-2 h-[35px] flex items-center justify-center">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-900">Burger King</p>
                                    <div>
                                        <p className="text-xs text-gray-500">Delivery in: 19 mins</p>
                                        <p className="text-xs text-gray-500">{completeAddress}</p>
                                    </div>
                                </div>
                            </div >
                            <div className='flex justify-between items-center mb-4'>
                                <p className="text-sm text-gray-600">{totalQuantity} item - Total: ₹ {totalPrice} </p>
                            </div>
                        </div>

                        <div className="mb-4">
                            <div className="bg-green-50 p-2 rounded-lg mb-4">
                                <p className="text-sm text-green-700">Save upto ₹ {receivedOffersData.offerAmount} more with payment offers</p>
                            </div>

                            <div className="mb-4">
                                <h2 className="text-lg font-semibold mb-2 text-gray-900">Credit & Debit Cards</h2>
                                <button className="flex items-center justify-between w-full bg-gray-50 hover:bg-gray-100 p-3 rounded-xl text-gray-700">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold mb-2 text-gray-900">More Payment Options</h2>
                                <div className="flex items-center justify-between bg-gray-50 p-3 rounded-xl mb-2 text-gray-700">
                                    <span>Wallets</span>
                                    <span>!!!</span>
                                </div>

                            </div>
                            <Button fullWidth pill className="mt-5" onClick={handlePayment}>Pay Now</Button>
                        </div>
                        </CardBody>
                    </Card>
                </div>
