...
const BottomLead = ({ actionText, description, mainActionText, extraActionText }) => {
    return (
        <div className="flex flex-col justify-center h-screen bg-blue-200 lg:pt-24 lg:pb-14 lg:bg-cover lg:h-full lg:bg-action md:bg-action sm:bg-action bg-action">
