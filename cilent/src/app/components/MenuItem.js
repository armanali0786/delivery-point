    ...
    return (
        <>
            {foods && foods.map((food, index) => {
                ...
                return (
                    <div className="w-full max-w-sm bg-white hover:bg-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer" onClick={() => handleNavigate(food.vendorId)}>
