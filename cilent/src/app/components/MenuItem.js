    ...
    return (
        <>
            {foods && foods.map((food, index) => {
                ...
                return (
                    <div key={index} className="w-full max-w-sm bg-white hover:bg-slate-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer" onClick={() => handleNavigate(food.vendorId)}>
                        ...
                        <div className="px-5 pb-2">
                            <div className="flex items-center justify-between">
                                ...
                                <div className='flex items-center'>
                                    ...
                                    <span className=" text-green-500 text-md font-semibold px-2.5 py-0.5 rounded">{food.rating}</span>
                                </div>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-xl font-bold text-gray-900 dark:text-white"> ₹{food.price}</span>
                                <a href="#" className="text-black font-medium text-sm px-1 py-2.5 text-cent">{food.readyTime} min</a>
                            </div>
