...
export default function SignUp() {
  ...
  return (
    <>
      <ToastContainer />
      <div className='flex min-h-[80vh] justify-center items-center bg-gray-50 py-10 px-4'>
        <Card hover={false} className="w-full max-w-[420px]">
          <CardBody>
            <p className="text-2xl font-bold text-gray-900 mb-1">Sign In</p>
            <p className="text-sm text-gray-500 mb-5">Welcome back, log in to continue.</p>
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
              {({ isSubmitting, errors, touched }) => (
                <Form>
                  ...
                  <p className="text-gray-500 text-sm mt-4 text-center">Create an account ? <Link to="/sign-up" className="text-primary-600 hover:text-primary-700 hover:underline">Signup</Link> </p>
                </Form>
              )}
            </Formik>
          </CardBody>
